  ...
  if (showLoading) {
    return (
      <DashboardLayout firmName={firmName}>
        <LoadingScreen message="Loading audits\u2026" fullScreen={false} />
      </DashboardLayout>
    );
  }
    ...
    <DashboardLayout firmName={firmName}>
      <div className="px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          <h1 className="font-display text-xl font-semibold text-foreground sm:text-2xl">Audit History</h1>
          <p className="mt-1 text-sm text-muted">Weekly AI visibility audits across ChatGPT, Perplexity, and Gemini.</p>
        </div>

        {/* Summary cards — H6: responsive grid */}
        ...
        {/* Audit list — H3: scrollable table on mobile */}
